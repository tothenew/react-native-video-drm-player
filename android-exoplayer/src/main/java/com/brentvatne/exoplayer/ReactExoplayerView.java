...
//            exoPlayerView.invalidateAspectRatio();
    ...
    private void initializeBasicPlayer() {
        if (player == null) {
...
//        return DataSourceUtil.getDataSourceFactory(getContext());
    }
...
//        if ((currentPositionMs == 0 && positionMs == 0 ) || (currentPositionMs != positionMs && player != null)) {
        if (player != null){
            seekTime = positionMs;
